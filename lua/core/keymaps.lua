...
vim.keymap.set('n', '<leader>ct', function()
  vim.cmd('tabnew')       -- horizontal split
  vim.cmd('terminal')    -- open terminal
  vim.cmd('startinsert') -- jump to terminal mode
end, opts)
...
vim.keymap.set("n", "<leader>ccs", function()
  require("core.csharp_constructor").generate_constructor()
end, { desc = "Generate C# constructor" })
